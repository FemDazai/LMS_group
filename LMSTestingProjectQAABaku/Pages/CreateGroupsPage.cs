...
namespace LMSTestingProjectQAABaku.Pages
{
    public class CreateGroupsPage: AbstractPage
    {
        ...
        public IWebElement CheckboxForChooseTeacher => _driver.FindElement(By.XPath(@"//span[text() = 'Admin Admin']"));
        public IWebElement CheckboxForChooseTutor => _driver.FindElement(By.XPath(@"//span[text() = 'Макар Океанов']"));
        public IWebElement ButtonForSave => _driver.FindElement(By.XPath(@"//button[@class = 'sc-bczRLJ iJvUkY btn btn-fill flex-container']"));
        public IWebElement TitleGroup => _driver.FindElement(By.XPath(@"//div[@class='tab-item active-tab']"));
