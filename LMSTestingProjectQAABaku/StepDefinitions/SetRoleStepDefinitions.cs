...
namespace LMSTestingProjectQAABaku.StepDefinitions
{
    ...
    public class SetRoleStepDefinitions
    {
        ...
        public void GivenRegistrationAsStudent()
        {
            ...
            buttonEmail.SendKeys("galinaivanovna@gmail.com");
        ...
        public void WhenClickTheButton(string вход)
        {
            ...
            wClient.SetRole(actualToken, 18988, "Teacher");
        }
        ...
        public void WhenAuthAsTeacher()
        {
            ...
            textbox1.SendKeys("galinaivanovna@gmail.com");
            Actions action = new Actions(_driver);
